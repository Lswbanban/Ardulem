...
const unsigned char MapData::MapSprite[][8] PROGMEM = {
	...
	{0x30, 0x30, 0x18, 0xf8, 0xf8, 0x18, 0x30, 0x30, }, {0x33, 0x3f, 0x3d, 0xff, 0xff, 0x3b, 0x37, 0x37, }, 
	{0x81, 0x42, 0x24, 0x18, 0x18, 0x24, 0x42, 0x81, }, {0x80, 0x40, 0x20, 0x10, 0x18, 0x24, 0x42, 0x81, }, 
	{0x1, 0x2, 0x4, 0x8, 0x18, 0x24, 0x42, 0x81, }, {0x00, 0x40, 0x68, 0x6c, 0x6c, 0x34, 0x36, 0x3f, }, 
...
const unsigned char Map02Loca[] PROGMEM = { 0x90, 0xB0, 0xB8, 0xBC, 0xB8, 0x30, 0x70, 0x78, 0x7C, 0x68, 0xF0, 0xF8, 0xD0, 0xE0, 0xE0, 0xF0, 0xE0, 0xE0, 0xF0, 0xF8, 0xF0, 0xE0, 0xC0, 0xE0, 0xC0, 0xE0, 0x70, 0x60, 0x70, 0x70, 0x38, 0x10, };
const unsigned int Map02IdList[] PROGMEM = {
	ID(22,9,31), ID(20,28,15), ID(31,25,28), ID(19,11,31), ID(25,28,15), ID(31,25,9), ID(27,21,19), ID(31,20,22), ID(18,31,24), ID(28,31,7),
	ID(31,26,22), ID(27,21,22), ID(28,31,20), ID(28,31,7), ID(31,26,22), ID(30,25,18), ID(31,24,27), ID(31,25,18), ID(31,31,24), ID(27,31,24),
	ID(28,31,25), ID(15,27,31), ID(25,19,11), ID(31,31,26), ID(15,29,31), ID(25,27,31), ID(24,30,24), ID(28,31,26), ID(31,25,27), ID(31,20,23),
	ID(31,21,29), ID(24,28,31), ID(26,27,31), ID(20,18,31), ID(21,22,0), MIRROR(21073), MIRROR(5766), MIRROR(186), MIRROR(707), MIRROR(4416), MIRROR(3342), MIRROR(72)};
