...
const unsigned char Map02Loca[] PROGMEM = { 0x90, 0x90, 0x98, 0x9C, 0xB8, 0x30, 0x70, 0x78, 0x7C, 0x68, 0xF0, 0xF8, 0xD0, 0xE0, 0xE0, 0xF0, 0x60, 0xE0, 0xF0, 0xF8, 0xF0, 0xE0, 0xC0, 0xE0, 0xC0, 0xE0, 0x70, 0x70, 0x38, 0x38, 0x1C, 0x8, };
const unsigned int Map02IdList[] PROGMEM = {
	...
	ID(27,31,25), ID(19,11,31), ID(31,26,15), ID(29,31,25), ID(27,31,24), ID(30,24,28), ID(31,26,31), ID(25,27,31), ID(20,23,31), ID(21,27,31),
	ID(20,28,31), ID(31,27,31), ID(21,18,31), ID(21,22,0), MIRROR(51373), MIRROR(17104), MIRROR(24599), MIRROR(120), MIRROR(57620), MIRROR(9424), MIRROR(9)};
